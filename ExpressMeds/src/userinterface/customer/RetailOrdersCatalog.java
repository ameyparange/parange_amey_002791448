 ...
 * @author amey8
 */
public class RetailOrdersCatalog extends javax.swing.JPanel {

    /**
     * Creates new form RetailOrdersCatalog
     */
    JdbcConnect connect;
    int itemno =0;
    ...
    String username;
    int corder_id;
    public RetailOrdersCatalog(Enterprise entp,String username) {
        initComponents();
