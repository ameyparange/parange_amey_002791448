...
public class Registerperson extends javax.swing.JPanel {
    ...
    public Registerperson(Community community, Patientdirectory patdir, Authentication auth, Hospitaldirectory hosdir, Credentials cred, Persondirectory perdir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        checkpat = new javax.swing.JCheckBox();
        checkdoc = new javax.swing.JCheckBox();
        checkhadm = new javax.swing.JCheckBox();
        checkcadm = new javax.swing.JCheckBox();
        ...
        checkpat.setFont(new java.awt.Font("Segoe UI", 0, 8)); // NOI18N
        checkpat.setText("Patient");

        checkdoc.setFont(new java.awt.Font("Segoe UI", 0, 8)); // NOI18N
        checkdoc.setText("Doctor");

        checkhadm.setFont(new java.awt.Font("Segoe UI", 0, 8)); // NOI18N
        checkhadm.setText("HosAdmin");

        checkcadm.setFont(new java.awt.Font("Segoe UI", 0, 8)); // NOI18N
        checkcadm.setText("CommAdmin");

        jLabel1.setBackground(new java.awt.Color(204, 204, 204));
        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setText("AccessType");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(checkhadm)
                    .addComponent(checkdoc)
                    .addComponent(checkpat)
                    .addComponent(checkcadm))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(checkpat, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(checkdoc, javax.swing.GroupLayout.PREFERRED_SIZE, 11, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(checkhadm, javax.swing.GroupLayout.PREFERRED_SIZE, 11, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(checkcadm, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jLabel15.setText("Doctor Specialization");
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        String tcheckcadm,tcheckdoc,tcheckhadm,tcheckpat;
        if(checkcadm.getText().isEmpty()){
           tcheckcadm="Community Admin";}
        else tcheckcadm="none";
        
        if(checkdoc.getText().isEmpty()){
           tcheckdoc="Doctor";}
        else tcheckdoc="none";
        
        
        if(checkhadm.getText().isEmpty()){
           tcheckhadm="Hospital Admin";}
        else tcheckhadm="none";
        
        if(checkpat.getText().isEmpty()){
           tcheckpat="Patient";}
        else tcheckpat="none";
        ...
        try {
            ...
            if (tfname.isEmpty() || tlname.isEmpty() || tage.isEmpty() || tmobileno.isEmpty() || tgender.isEmpty()
                ...
                if (val.valstring(tfname) == false || val.valstring(tlname) == false) {
                    ...
                    dr.setFirstname(tfname);
                    dr.setLastname(tlname);
                ...
                if (!val.valage(tage) || Integer.valueOf(tage) <= 0 || Integer.valueOf(tage) > 200) {
                    ...
                    dr.setAge(Integer.valueOf(tage));
                    dr.setGender(tgender);
                }
                ...
                if (er != true) {
                    if(!perdir.checkpersonexist(pat))
                    {
                        ...
                        add.setAddress_id();
                        if (tcheckpat.equalsIgnoreCase("none"))
                        {
                        ...
                        if (tcheckdoc.equalsIgnoreCase("none")) 
                        {
                            docdir.deletedoctorrec(9999);
                             ...
                             dr.setDoctor_id();
                             dr.setPersonid();
                             dr.setAddressid(add.getAddress_id());
                            docdir.addnewdoctor(dr);
                        }
                        perdir.adddoctor(dr,"0","1","0","0");
                        community.addnewaddress(add);

        if (tcheckcadm.equalsIgnoreCase("Community Admin"))
        {
                        Credentials cred1= new Credentials(tusername, "Community Admin", tpassword, pat.getPersonid()-1);
                        auth.addnewcredentials(cred1);
        }
        if (tcheckdoc.equalsIgnoreCase("Doctor"))
        {
                        Credentials cred1= new Credentials(tusername, "Doctor", tpassword, pat.getPersonid()-1);
                        auth.addnewcredentials(cred1);
        }
        if (tcheckhadm.equalsIgnoreCase("Hospital Admin"))
        {
                        Credentials cred1= new Credentials(tusername, "Hospital Admin", tpassword, pat.getPersonid()-1);
                        auth.addnewcredentials(cred1);
        }
        if (tcheckpat.equalsIgnoreCase("Patient"))
        {
                        Credentials cred1= new Credentials(tusername, "Patient", tpassword, pat.getPersonid()-1);
                        auth.addnewcredentials(cred1);
        }
    ...
    private void btnclearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclearActionPerformed
        ...
        tfpassword.setText("");
        tfspec.setText("");
        checkpat.setSelected(false);
        checkdoc.setSelected(false);
        checkcadm.setSelected(false);
        checkhadm.setSelected(false);
    }//GEN-LAST:event_btnclearActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JCheckBox checkcadm;
    private javax.swing.JCheckBox checkdoc;
    private javax.swing.JCheckBox checkhadm;
    private javax.swing.JCheckBox checkpat;
