...
public class Doctoractions extends javax.swing.JPanel {
    ...
    public Doctoractions(Community community,  Authentication auth, Hospitaldirectory hosdir, 
            ...
            if (tfname.isEmpty() || tlname.isEmpty() || tage.isEmpty() || tmobileno.isEmpty() || tgender.isEmpty()
                ...
                if (val.valusername1(tusername, docdir.getDocdir()) == 1) {
                    ...
                    JOptionPane.showMessageDialog(this, "Please username in Proper format (a-z,A-Z,_)",
                        ...
                        JOptionPane.ERROR_MESSAGE);
                    er = true;
                }else if (val.valusername1(tusername, docdir.getDocdir()) == 2) {
                ...
                if (er != true) {
                    ...
                    community.addnewaddress(add);
                    Credentials cred1= new Credentials(tusername, "Doctor", tpassword, dr.getPersonid()-1);
                    auth.addnewcredentials(cred1);
                    Fileload file1=new Fileload();
                    file1.loadcredentialsfile(auth);

                        JOptionPane.showMessageDialog(this, "Successfully Doctor Profile Created!!!");
        ...
        try {
            ...
            if (tfname.isEmpty() || tlname.isEmpty() || tage.isEmpty() || tmobileno.isEmpty() || tgender.isEmpty()
                ...
                if (er != true) {
                    ...
                    pat1.setPersonid(cdr.getPersonid());
                    pat1.setDoctor_id(cdr.getDoctor_id());
                    
                    add.setAddress_id(cdr.getAddressid());

                    pat1.setAddressid(cdr.getAddressid());
                    docdir.updatedoctor(pat1, cdr.getDoctor_id());
                    
                    perdir.updatepersondoc(pat1,cdr.getPersonid());
                    community.updateaddress(add, cdr.getAddressid());
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        if (!tfusername.getText().isEmpty()) {
            ...
            for (Doctor emp1 : docdir.getDocdir()) {
